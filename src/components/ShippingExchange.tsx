  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <div className="text-center mb-8">
        <h1 className="text-3xl sm:text-4xl font-sans font-extrabold text-neutral-900 tracking-tight">Shipping & Exchange Policy</h1>
        <p className="text-neutral-500 text-sm mt-2 font-medium">Everything you need to know about delivery times and exchanges.</p>
      </div>
      ...
      <div className="space-y-8 bg-white border border-neutral-200/80 rounded-3xl p-6 sm:p-10 shadow-sm text-neutral-600">
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-neutral-900 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#3d70f5]"></span> 1. Shipping Timelines & Delivery
          </h2>
        ...
        <section className="space-y-3 pt-6 border-t border-neutral-100">
          <h2 className="text-lg font-bold text-neutral-900 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#3d70f5]"></span> 2. Order Tracking
          </h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3 pt-6 border-t border-neutral-100">
          <h2 className="text-lg font-bold text-neutral-900 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#3d70f5]"></span> 3. Exchange Terms
          </h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3 pt-6 border-t border-neutral-100">
          <h2 className="text-lg font-bold text-neutral-900 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#3d70f5]"></span> 4. Shipping Cost for Exchange
          </h2>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-3 pt-6 border-t border-neutral-100">
          <h2 className="text-lg font-bold text-neutral-900 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[#3d70f5]"></span> 5. Exchange Fulfillment
          </h2>
          <p className="text-sm leading-relaxed">
